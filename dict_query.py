def get_dict_query():
    dict_query = {'Создать таблицы в BD': """
        ...
        """,
                  ...
                  'Приветствие':f'Приветствую Вас 👋, я ваш персональный помощник по созданию привычек, и '
